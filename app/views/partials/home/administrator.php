        ...
        <div class="container">
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    <h4 >Welcome Admin <?php echo USER_NAME;?></h4>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row ">
                ...
                <div class="col-md-3 col-sm-4 comp-grid">
                    ...
                    <a class="animated zoomIn record-count card bg-primary card-white text-white"  href="<?php print_link("prescription/") ?>">
                        <div class="row">
                            <div class="col-2">
                ...
                <div class="col-md-3 col-sm-4 comp-grid">
                    ...
                    <a class="animated zoomIn record-count card bg-primary card-white text-white"  href="<?php print_link("reminder/") ?>">
                        <div class="row">
                            <div class="col-2">
                ...
                <div class="col-md-3 col-sm-4 comp-grid">
                    ...
                    <a class="animated zoomIn record-count card bg-primary card-white text-white"  href="<?php print_link("reviews/") ?>">
                        <div class="row">
                            <div class="col-2">
