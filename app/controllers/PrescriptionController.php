...
class PrescriptionController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				prescription.id LIKE ? OR 
				prescription.medicine LIKE ? OR 
				prescription.quantity LIKE ? OR 
				prescription.times LIKE ? OR 
				prescription.days_prescribed LIKE ? OR 
				prescription.number_refils LIKE ? OR 
				prescription.instructions LIKE ? OR 
				prescription.patient LIKE ? OR 
				prescription.doctor LIKE ? OR 
				prescription.date LIKE ?
			)";
			$search_params = array(
	...
	function view($rec_id = null, $value = null){
		...
		if($value){
			...
			$db->where("prescription.id", $rec_id);; //select record based on primary key
		}
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("medicine","quantity","times","days_prescribed","number_refils","instructions","patient","doctor","date");
			...
			$this->sanitize_array = array(
				'medicine' => 'sanitize_string',
				'quantity' => 'sanitize_string',
				'times' => 'sanitize_string',
				'days_prescribed' => 'sanitize_string',
				'number_refils' => 'sanitize_string',
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","medicine","quantity","times","days_prescribed","number_refils","instructions","patient","doctor","date");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'medicine' => 'required',
